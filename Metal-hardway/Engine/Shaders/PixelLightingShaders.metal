...
fragment float4 pixelLightingFragmentShader(VertexOut in [[stage_in]],
                               constant PixelLightingUniforms &uniforms [[buffer(0)]]) {
...
vertex VertexOut pixelLightingVertexShader(uint vertexID [[vertex_id]]) {
  float2 positions[6] = {
